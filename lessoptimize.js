...
function createDomElements(data) {
    ...
    console.log("Current Children are :",currentChildren)
    ...
    data.forEach(function(item) {
      ...
      console.log("Current child before :", currentChildren)
      ...
      if (existingChild) {
        ...
        console.log("Existing child after :", existingChild)
        console.log("Current child after:", currentChildren)
      } else {
        added++;
